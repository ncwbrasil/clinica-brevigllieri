...
{
	jQuery("#form_cadastro_noticias").attr("action","cadastro_noticias.php?pagina=cadastro_noticias_editar&action=editar&nt_id="+nt_id+"<?php echo $autenticacao;?>");
	jQuery("#form_cadastro_noticias").submit();
}
...
{
	jQuery('#icon02').click(function () {
				
			jQuery('#icon01').removeClass("active");
			jQuery('#icon02').addClass("active");
			jQuery('#icon03').removeClass("active");
			jQuery('.descricao01').hide();
			jQuery('.descricao02').show();
			jQuery('.descricao03').hide();
		});
		jQuery('#icon01').click(function () {
				
			jQuery('#icon03').removeClass("active");
			jQuery('#icon02').removeClass("active");
			jQuery('#icon01').addClass("active");
			jQuery('.descricao03').hide();
			jQuery('.descricao02').hide();
			jQuery('.descricao01').show();
		});
		jQuery('#icon03').click(function () {
				
			jQuery('#icon01').removeClass("active");
			jQuery('#icon02').removeClass("active");
			jQuery('#icon03').addClass("active");
			jQuery('.descricao01').hide();
			jQuery('.descricao02').hide();
			jQuery('.descricao03').show();
		});
...
/// CADASTRO - NOTICIAS ///
	jQuery("#bt_cadastro_noticias, #bt_cadastro_noticias_sair").click(function()
	{
		cadastro_noticias=0;
		if(jQuery("#nt_titulo").val() == ''){cadastro_noticias++;jQuery("#nt_titulo").css({"border" : "1px solid #F90F00"});}
		else{jQuery("#nt_titulo").css({"border" : "1px solid #AAA"});}
		if(cadastro_noticias == 0)
		{
			if(jQuery(this).val() == "Salvar")
			{
				jQuery("#form_cadastro_noticias").attr("action","cadastro_noticias.php?pagina=cadastro_noticias_editar&action=adicionar&nt_id=<?php echo $nt_id.$autenticacao;?>");
			}
			jQuery("#form_cadastro_noticias").submit();
		}
		else
